...
type UserServiceClient interface {
	// FIX: 'returns' must be plural, and 'Request' was missing the 'e'
...
func (c *userServiceClient) ValidateUser(ctx context.Context, in *ValidateRequest, opts ...grpc.CallOption) (*ValidateResponse, error) {
...
func (UnimplementedUserServiceServer) ValidateUser(context.Context, *ValidateRequest) (*ValidateResponse, error) {
...
func _UserService_ValidateUser_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserServiceServer).ValidateUser(ctx, req.(*ValidateRequest))
	}
