...
// FIX: Spelling corrected to 'Request'
...
const file_proto_user_proto_rawDesc = "" +
	...
	"\bis_valid\x18\x01 \x01(\bR\aisValid2L\n" +
	"\vUserService\x12=\n" +
	"\fValidateUser\x12\x15.user.ValidateRequest\x1a\x16.user.ValidateResponseB\x1dZ\x1bmy-microservices/proto/userb\x06proto3"
...
var file_proto_user_proto_depIdxs = []int32{
	0, // 0: user.UserService.ValidateUser:input_type -> user.ValidateRequest
	1, // 1: user.UserService.ValidateUser:output_type -> user.ValidateResponse
