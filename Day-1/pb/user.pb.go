...
const file_user_proto_rawDesc = "" +
	"\n" +
	"\n" +
	"user.proto\x12\x05hello\"!\n" +
	"\vUserRequest\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\"(\n" +
	"\fUserResponse\x12\x18\n" +
	"\amessage\x18\x01 \x01(\tR\amessage2C\n" +
	"\fHelloService\x123\n" +
	"\bSayHello\x12\x12.hello.UserRequest\x1a\x13.hello.UserResponseB\x06Z\x04./pbb\x06proto3"
...
var file_user_proto_depIdxs = []int32{
	0, // 0: hello.HelloService.SayHello:input_type -> hello.UserRequest
	1, // 1: hello.HelloService.SayHello:output_type -> hello.UserResponse
